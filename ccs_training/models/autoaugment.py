...
class SubPolicy(object):
    def __init__(self, p1, operation1, magnitude_idx1, p2, operation2, magnitude_idx2, fillcolor=(128, 128, 128)):
        self.p1 = p1
        self.operation1 = name2op[operation1]
        self.magnitude1 = ranges2value[operation1][magnitude_idx1]
        self.p2 = p2
        self.operation2 = name2op[operation2]
        self.magnitude2 = ranges2value[operation2][magnitude_idx2]
        self.fillcolor = fillcolor


    def __call__(self, img):
        if random.random() < self.p1: img = self.operation1(img, self.magnitude1, self.fillcolor)
        if random.random() < self.p2: img = self.operation2(img, self.magnitude2, self.fillcolor)
        return img
...
def rotate_with_fill(img, magnitude, fillcolor):
